          ...
          <div className="parentline flex flex-col gap-10 md:items-center md:justify-between md:gap-5">
            ...
            >
              <p className="text-[#aaa] font-medium text-sm md:leading-[1.5em] md:text-xl normal-case">
                <span className="text-[#777] text-sm mr-2 uppercase">About: </span>A highly skilled Senior Frontend Engineer with over 5 years of experience building dynamic, high-performance web applications. Proficient in NextJS, ReactJS, JavaScript, TypeScript, CSS, HTML, and Git-based workflows. Extensive experience in Fintech and product companies. Adept at working remotely and collaborating across distributed teams. Strong problem-solving abilities, with a deep understanding of software development life cycles, CI/CD processes, and Agile methodologies. Fluent in English, with exceptional communication skills and the ability to translate complex technical requirements into elegant user interfaces.
                <br />
                <br />
              </p>
            </div>
